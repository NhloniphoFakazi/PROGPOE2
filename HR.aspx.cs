    ...
    public partial class HR : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // Sample data
                claimsTable.Rows.Add("C001", "Asanda", "PROG6212", "Programming 2A", 110, 10, 1000, "doc1.pdf", "Pending");
                claimsTable.Rows.Add("C002", "Wandile", "HCIN6212", "Human Computer Interaction", 150, 5, 750, "doc2.pdf", "Pending");
                claimsTable.Rows.Add("C003", "Buhlebenkosi", "DATA622", "Database (Intermediate)", 120, 8, 960, "doc3.pdf", "Pending");
                claimsTable.Rows.Add("C004", "Siya", "IPMA6212", "IT Project Management", 150, 12, 1320, "doc4.pdf", "Pending");
